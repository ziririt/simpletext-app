...
- 현재 버전: **3.17.12+234** (`pubspec.yaml`, `lib/version.dart`)
- App Store 마케팅 버전: **1.6** — 2026-09-09 심사 대기, 붙은 빌드 **234**.
  225 → 230 → 234 로 두 번 갈아 끼웠다(§4.1-4).
  내용: 안드로이드 문구 정리 + 화면 전환 + 광고 구조 + **스크롤 책갈피**
